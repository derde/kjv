...
\fontspec{Arial}
\setmainfont[Numbers=Uppercase]{Times New Roman} % Times New Roman is pretty good 996 pages
...
%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\bibldropcapschapter}[1]{\needspace{3\baselineskip}\lettrine[lines=2, lraise=0.1, lhang=0.05, findent=3pt, nindent=3pt, loversize=0.1]{\textbf{\mychapterfont #1}}{}}
